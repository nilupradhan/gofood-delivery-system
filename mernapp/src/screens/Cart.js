    ...
    return (
        <div>
            <div className='container m-auto mt-5 table-responsive table-responsive-sm table-responsive-md'>
                    ...
                    <tbody>
                        {
                            data.map((food, index) => (
                                <tr>
                                    ...
                                    <td><button type='button' className='btn p-0 bg-white'><img src={trash} alt='delete' onClick={() => { dispatch({ type: "REMOVE", index: index }) }}></img></button></td>
                                </tr>
                            ))
                        }
                    </tbody>
                ...
                <div>
                    <button className='btn btn-sucess mt-5 text-white' onClick={handleCheckOut}>Check Out</button>
                </div>
            </div>
        </div>
    )
